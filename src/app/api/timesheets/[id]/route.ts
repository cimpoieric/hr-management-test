...
export async function DELETE(
  ...
  try {
    ...
    if (payslip) {
      return NextResponse.json({ error: "Șterge mai întâi fluturașul" }, { status: 400 });
    }
    ...
    return NextResponse.json({ error: "Eroare la ștergerea pontajului" }, { status: 500 });
  }
}
...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({ error: "Eroare la citirea pontajului" }, { status: 500 });
  }
}
...
export async function PUT(
  ...
  try {
    ...
    if (existing.status === "APPROVED") {
      return NextResponse.json({ error: "Pontajul APPROVED nu poate fi editat" }, { status: 400 });
    }
    ...
    return NextResponse.json({ error: "Eroare la actualizarea pontajului" }, { status: 500 });
  }
}

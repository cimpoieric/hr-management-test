...
const step1Schema = z
  .object({
    ...
    adminPasswordConfirm: z
      .string()
      .min(6, "Confirmarea parolei e obligatorie"),
  })
    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between text-xs text-gray-500">
        {STEPS.map((s, idx) => (
          <div
            key={s}
            className={idx <= step ? "text-gray-900 font-medium" : ""}
          >
            {idx + 1}. {s}
          </div>
        ))}
...
export default function SetupWizard() {
  ...
  async function testSmtp() {
    ...
    if (!parsed.success) {
      toast.error(
        parsed.error.issues[0]?.message ?? "Completează câmpurile SMTP",
      );
      return;
    }
    setLoading(true);
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="mx-auto max-w-lg px-4 pt-16 pb-12">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Acest cont va gestiona aplicația.
                  </p>
                </div>
                <div>
            ...
            {step === 1 && (
              <div className="space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Datele companiei apar pe documente și rapoarte.
                  </p>
                </div>
                <div>
                  <label className="text-xs font-medium text-gray-600">
                  ...
                  <input
                    ...
                    placeholder="ex: Cedol Autocraft SRL"
                  />
                </div>
                <div>
                  <label className="text-xs font-medium text-gray-600">
                    Cod fiscal (CUI) (opțional)
                  </label>
                  <input
                    className="mt-1 w-full rounded-lg border px-3 py-2 text-sm"
            ...
            {step === 2 && (
              <div className="space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Este necesar pentru trimiterea fluturașilor pe email.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                  ...
                  <div className="md:col-span-2">
                    ...
                    />
                    <div className="mt-1 text-xs text-gray-500">
                      Parola se salvează criptat (ENCRYPTION_KEY).
                    </div>
                  </div>
                  <div className="md:col-span-2">
                    <label className="text-xs font-medium text-gray-600">
                ...
                <div className="flex items-center justify-between gap-3 pt-2">
                  ...
                  <div className="text-xs text-gray-500">
                    Recomandat înainte de finalizare.
                  </div>
                </div>
              </div>
            )}
        ...
        <div className="mt-6 text-center text-xs text-gray-400">
          Setup inițial — disponibil doar când nu există niciun user în baza de
          date.
        </div>
      </div>
    </div>

...
async function fetchPayslips(
  ...
  lng: SupportedLng,
): Promise<{ items: PayslipListItem[]; pagination: Pagination }> {
  ...
  const url = `${origin}/api/payroll?${params.toString()}`;
  ...
  if (!res.ok) {
    ...
    throw new Error(err.error ?? serverT(lng, "pages.payroll.fetchListError"));
  }

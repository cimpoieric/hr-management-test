...
export default function ImportManualPage() {
  ...
  async function handleUpload() {
    ...
    try {
      ...
      router.push(`${ROUTES.imports}/${data.id}`);
    } catch {
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      >
        ...
        {uploading ? (
          <div className="space-y-3">
            <Loader2
              size={40}
              className="mx-auto text-slate-900 animate-spin"
            />
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                ...
                {isPDF ? "PDF" : isImage ? "Imagine" : "Fișier"}
              </p>
            </div>
            <button
              onClick={(e) => {
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-800">
        ...
        <p className="text-amber-700">
          Sistemul încearcă să detecteze automat CNP, nume, IBAN, telefon,
          email. Verifică întotdeauna datele extrase înainte de a salva. Pentru
          documente scanate de calitate slabă, OCR poate produce erori.
        </p>
      </div>
    </div>
  );

              ...
              <div className="space-y-3">
                <div className="flex items-start gap-2 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                  ...
                  <div className="text-sm">
                    <p className="font-medium text-amber-800">Angajat existent detectat</p>
                    <p className="text-amber-700 mt-1">{data.duplicateEmployee.name}</p>
                    <p className="text-amber-600 text-xs">CNP: {data.duplicateEmployee.cnp}</p>
                  </div>
                </div>
                <Link
